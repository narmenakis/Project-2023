...
// if request is POST remove from transaction
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['transaction_id'])) {
    ...
    function takeOverTransaction($transaction_id, $user_id)
    {
        ...
        // SQL update status to 'acquired'
        $sql = "UPDATE transaction 
                SET status = 'acquired', vehicle_id = ?, transaction_date = NOW()
    ...
    //take over trnasaction from rescuer
