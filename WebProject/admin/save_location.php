...
// check if coordinates are checked correctly
...
$sql_check = "SELECT user_coordinates_id FROM user";
...
if (!is_null($user_coordinates_id)) {
    ...
    $sql_update = "UPDATE coordinates SET latitude = ?, longitude = ?";
